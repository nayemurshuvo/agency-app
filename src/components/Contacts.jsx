                            ...
                            <div className="mb-6 py-8 px-6 bg-white shadow rounded-t-3xl rounded-bl-3xl text-center">
                                <form onSubmit={FormSubmit} action="">
                                    ...
                                    <div className="mb-4 flex flex-wrap -mx-2">
                                        <div value={FormValue.fname} onChange={(e)=>{inputOnChange('fname',e.target.value)}} className="mb-4 lg:mb-0 w-full lg:w-1/2 px-2">
                                    ...
                                    <input value={FormValue.email} onChange={(e)=>{inputOnChange('email',e.target.value)}} className="mb-4 py-2 px-3 w-full bg-gray-50 rounded leading-loose" type="email" placeholder="nayemurshuvo@gmail.com"/>
